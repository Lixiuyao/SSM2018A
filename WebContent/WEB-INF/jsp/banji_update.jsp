	...
	<body>
		...
		<nav class="navbar navbar-default" role="navigation">
		    ...
		    <div class="collapse navbar-collapse" id="example-navbar-collapse">
		        <ul class="nav navbar-nav">
		            ...
		            <li><a href="${cctv}/banji?method=findAll"><span class="glyphicon glyphicon-search aria-hidden="true"></span>&nbsp;&nbsp;班级管理</a></li>
       ...
       <div class="container">
			...
			<div class="list-group">
			  	<a href="${cctv}/student?method=findStudents" class="list-group-item">班级信息</a>
		 	...
		 	<div class="col-md-8">
		 		...
		 		<form action="${cctv}/banji?method=update" method="post">
		 			<input type="hidden" name="id" value="${banji.id}">
		 			<div class="form-group">
				    <label for="exampleInputEmail1">班级编号</label>
				    <input type="text" class="form-control" name="id" value="${banji.id}">
				  </div>
				  <div class="form-group">
				    <label for="exampleInputEmail1">班级名称</label>
				    <input type="text" class="form-control" name="name" value="${banji.name}">
				  </div>
				  <div class="form-group">
				    <label for="exampleInputPassword1">班级人数</label>
				    <input type="text" class="form-control" name="number" value="${banji.number}">
				  </div>
